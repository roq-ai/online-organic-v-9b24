...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'store-manager', 'delivery-personnel', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Deliveries', path: '/deliveries', entity: 'delivery', service: AccessServiceEnum.PROJECT, icon: FiBox },
