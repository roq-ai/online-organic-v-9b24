  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of grocery shopping with Online Organic Vegetables. Your one-stop solution for food, vegetable, and grocery delivery at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1695653422259-8a74ffe90401?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxncm9jZXJ5fGVufDB8fHx8MTY5NzUzODQwMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of grocery shopping with Online Organic Vegetables. Your one-stop solution for food, vegetable, and grocery delivery at your fingertips.`}
            </Text>
            <Box
