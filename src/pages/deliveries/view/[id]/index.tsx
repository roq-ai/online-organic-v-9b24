...
import { useDeliveryFindFirst, useRoqClient } from 'lib/roq';
...
function DeliveryViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; order: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useDeliveryFindFirst(queryParams, {}, { disabled: !id });
